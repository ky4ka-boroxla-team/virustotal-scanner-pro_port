...
const std::unordered_map<std::string, std::string> RU = {
    ...
    {"select_file_builtin", "Выбрать файл (встроенный)"},
    {"browser_title", "Выбор файла"},
    {"browser_up", ".. (вверх)"},
    {"browser_select", "Выбрать"},
    {"file_too_large", "Файл больше 32 МБ — не поддерживается"},
    {"rate_limited_prefix", "Лимит запросов (4/мин) исчерпан. Подождите"},
    {"seconds_short", " сек"},
    {"about_text",
...
const std::unordered_map<std::string, std::string> EN = {
    ...
    {"select_file_builtin", "Select file (built-in)"},
    {"browser_title", "Select file"},
    {"browser_up", ".. (up)"},
    {"browser_select", "Select"},
    {"file_too_large", "File exceeds 32 MB — not supported"},
    {"rate_limited_prefix", "Rate limit (4/min) reached. Wait"},
    {"seconds_short", "s"},
    {"about_text",
        "VirusTotal Scanner Pro (C++ / Dear ImGui + OpenGL + X11)\n\n"
        "Logic:\n"
